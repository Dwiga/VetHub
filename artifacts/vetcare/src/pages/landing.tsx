...
const copy = {
  en: {
    badge: "Built for Indonesian veterinary clinics",
    ...
    impactBannerSub:
      "Every clinic that uses VetCare Pro helps fund stray animal care across Indonesia.",
    ...
    whoTitle: "Who is VetCare Pro for?",
    roles: [
      {
        title: "Pet owners",
        items: [
    ...
    impactBody:
      "5% of every rupiah we earn is donated to street animal rescue organizations across Indonesia. When you use VetCare Pro, you're not just caring for your pet — you're giving countless stray animals a chance at a better life.",
    impactTag:
    ...
    ctaSectionSub:
      "Join clinics and pet owners across Indonesia who trust VetCare Pro for every visit, every vaccination, every check-up.",
  ...
  id: {
    ...
    heroSub:
      "VetCare Pro menghubungkan pemilik hewan, dokter hewan, dan pemilik klinik — agar hewan mendapat perawatan terbaik dan klinik berjalan lancar.",
    ctaPrimary: "Mulai gratis",
    ctaSecondary: "Masuk",
    stat1Val: "100%",
    stat1Lbl: "Gratis untuk memulai",
    ...
    impactBannerSub:
      "Setiap klinik yang menggunakan VetCare Pro turut mendanai perawatan hewan liar di seluruh Indonesia.",
    ...
    whoTitle: "VetCare Pro untuk siapa?",
    roles: [
      {
        title: "Pemilik hewan",
        items: [
    ...
    impactBody:
      "5% dari setiap rupiah yang kami hasilkan disumbangkan ke organisasi penyelamatan hewan liar di seluruh Indonesia. Saat Anda menggunakan VetCare Pro, Anda tidak hanya merawat hewan peliharaan — Anda memberikan kesempatan hidup lebih baik bagi hewan-hewan liar.",
    impactTag:
    ...
    ctaSectionSub:
      "Bergabung bersama klinik dan pemilik hewan di seluruh Indonesia yang mempercayai VetCare Pro untuk setiap kunjungan, vaksinasi, dan pemeriksaan.",
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-[#0d2d2a]" style={{ fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}>
      ...
      <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-[hsl(175,30%,90%)]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-lg font-bold text-[hsl(175,70%,25%)]">VetCare Pro</span>
          </div>
          ...
          <div className="hidden sm:flex items-center gap-2">
            ...
            <Link href="/sign-up">
              <span className="px-4 py-2 rounded-lg text-sm font-semibold bg-[hsl(175,70%,25%)] text-white hover:bg-[hsl(175,70%,20%)] transition-colors cursor-pointer" data-testid="btn-get-started">
                {c.ctaPrimary}
              </span>
            </Link>
          </div>
            ...
            <div className="flex bg-[hsl(175,30%,94%)] rounded-lg p-0.5 gap-0.5">
              <button
                ...
                className={`px-2.5 py-1 rounded-md text-xs font-semibold transition-all ${
                  lang === "en" ? "bg-[hsl(175,70%,25%)] text-white" : "text-[hsl(175,70%,25%)]"
                }`}
              >EN</button>
              <button
                onClick={() => setLang("id")}
                className={`px-2.5 py-1 rounded-md text-xs font-semibold transition-all ${
                  lang === "id" ? "bg-[hsl(175,70%,25%)] text-white" : "text-[hsl(175,70%,25%)]"
                }`}
              >ID</button>
            </div>
        ...
        {menuOpen && (
          <div className="sm:hidden border-t border-[hsl(175,30%,90%)] bg-white px-4 py-3 flex flex-col gap-2">
            ...
            <Link href="/sign-up">
              <span className="block w-full text-center py-2.5 rounded-lg font-semibold bg-[hsl(175,70%,25%)] text-white hover:bg-[hsl(175,70%,20%)] transition-colors cursor-pointer" data-testid="btn-get-started-mobile">
                {c.ctaPrimary}
              </span>
            </Link>
          </div>
      ...
      <section
        ...
        style={{ background: "linear-gradient(135deg, hsl(175,60%,10%) 0%, hsl(175,70%,18%) 55%, hsl(175,50%,22%) 100%)" }}
      >
        {/* Decorative blobs */}
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link href="/sign-up">
              <span className="flex items-center justify-center gap-2 px-7 py-3.5 rounded-xl bg-white text-[hsl(175,70%,25%)] font-bold text-[15px] hover:bg-white/90 transition-colors cursor-pointer" data-testid="btn-get-started">
                {c.ctaPrimary} <ArrowRight className="w-4 h-4" />
              </span>
            </Link>
            <Link href="/sign-in">
              <span className="flex items-center justify-center px-7 py-3.5 rounded-xl bg-white/10 border border-white/25 text-white font-semibold text-[15px] hover:bg-white/15 transition-colors cursor-pointer" data-testid="btn-sign-in">
                {c.ctaSecondary}
              </span>
            </Link>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 bg-[#f8fffe]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            <span className="text-xs font-bold text-[hsl(175,60%,40%)] tracking-widest uppercase">{c.featuresEyebrow}</span>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-[#0d2d2a] mt-2 tracking-tight">{c.featuresTitle}</h2>
            <p className="text-[#5a7a76] text-base mt-3 max-w-lg mx-auto leading-relaxed">{c.featuresSub}</p>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-[#0d2d2a] text-center mb-12 tracking-tight">{c.whoTitle}</h2>
            ...
            {c.roles.map((role, i) => {
              ...
              return (
                <div key={role.title} className="rounded-2xl p-8 border-2" style={{ background: bg, borderColor: bg }}>
                  <div className="w-13 h-13 rounded-2xl flex items-center justify-center mb-5" style={{ background: color, width: 52, height: 52 }}>
      ...
      <section
        ...
        style={{ background: "linear-gradient(135deg, hsl(175,70%,12%) 0%, hsl(175,60%,20%) 100%)" }}
      >
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-[16px] text-white/72 leading-relaxed mb-7">
            <strong className="text-[#7ae8d8]">
              {lang === "en" ? "5% of every rupiah we earn" : "5% dari setiap rupiah yang kami hasilkan"}
            </strong>{" "}
            {lang === "en"
              ? " is donated to street animal rescue organizations across Indonesia. When you use VetCare Pro, you're not just caring for your pet — you're giving countless stray animals a chance at a better life."
              : " disumbangkan ke organisasi penyelamatan hewan liar di seluruh Indonesia. Saat Anda menggunakan VetCare Pro, Anda tidak hanya merawat hewan peliharaan — Anda memberikan kesempatan hidup lebih baik bagi hewan-hewan liar."}
          </p>
      ...
      <footer className="px-4 sm:px-6 py-10" style={{ background: "hsl(175,50%,10%)" }}>
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-2.5 mb-7">
            ...
            <span className="text-base font-bold text-white">VetCare Pro</span>
          </div>
          <div className="border-t border-white/10 pt-5 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
            <p className="text-[12px] text-white/40">© 2026 VetCare Pro. {c.footerTagline}</p>
