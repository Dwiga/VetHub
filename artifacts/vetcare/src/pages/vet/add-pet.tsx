...
import { useAddPetForOwner, useListSpecies } from "@workspace/api-client-react";
...
export default function AddPetForOwnerPage() {
  ...
  async function onSubmit(values: z.infer<typeof schema>) {
    ...
    toast({ title: `${pet.name} registered` });
    setLocation("/vet/search");
  }
