...
import { useGetDailyReport, useUpdateDailyReport, getGetDailyReportQueryKey } from "@workspace/api-client-react";
...
export default function DailyReportPage() {
  ...
  const report = useGetDailyReport(id, { query: { queryKey: getGetDailyReportQueryKey(id) } });
  ...
  async function onSubmit(values: z.infer<typeof schema>) {
    ...
    queryClient.invalidateQueries({ queryKey: getGetDailyReportQueryKey(id) });
