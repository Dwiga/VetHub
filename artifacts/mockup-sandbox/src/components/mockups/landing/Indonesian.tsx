    ...
    <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", background: "#fff", color: "#0d2d2a", minHeight: "100vh" }}>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <div style={{ display: "flex", background: "hsl(175,30%,94%)", borderRadius: 8, padding: 3, gap: 2 }}>
              <a href="/__mockup/preview/landing/English" style={{ padding: "5px 14px", borderRadius: 6, color: teal, fontSize: 13, fontWeight: 500, textDecoration: "none" }}>EN</a>
              <span style={{ padding: "5px 14px", borderRadius: 6, background: teal, color: "#fff", fontSize: 13, fontWeight: 600 }}>ID</span>
            </div>
            <a href="/sign-in" style={{ padding: "8px 18px", borderRadius: 8, color: teal, fontSize: 14, fontWeight: 600, textDecoration: "none" }}>Masuk</a>
            <a href="/sign-up" style={{ padding: "8px 20px", borderRadius: 8, background: teal, color: "#fff", fontSize: 14, fontWeight: 600, textDecoration: "none" }}>Mulai gratis</a>
          </div>
        </div>
      </nav>
      ...
      <section style={{ background: `linear-gradient(135deg, hsl(175,60%,10%) 0%, hsl(175,70%,18%) 50%, hsl(175,50%,22%) 100%)`, padding: "96px 24px 80px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center", position: "relative" }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(255,255,255,0.12)", borderRadius: 100, padding: "6px 16px", marginBottom: 24, border: "1px solid rgba(255,255,255,0.18)" }}>
            ...
            <span style={{ fontSize: 13, color: "#7ae8d8", fontWeight: 500 }}>Dirancang untuk klinik hewan Indonesia</span>
          </div>
          <h1 style={{ fontSize: "clamp(36px, 5vw, 64px)", fontWeight: 800, color: "#fff", lineHeight: 1.15, marginBottom: 20, letterSpacing: "-0.02em" }}>
            Cara paling cerdas<br />untuk merawat <span style={{ color: "#7ae8d8" }}>setiap hewan</span>
          </h1>
          <p style={{ fontSize: "clamp(15px, 2vw, 19px)", color: "rgba(255,255,255,0.72)", maxWidth: 620, margin: "0 auto 36px", lineHeight: 1.65 }}>
          ...
          <div style={{ display: "flex", gap: 16, justifyContent: "center", marginTop: 48, flexWrap: "wrap" }}>
            {[["100%", "Gratis untuk memulai"], ["Semua-dalam-satu", "Platform pet + klinik"], ["Indonesia", "Dirancang untuk Anda"]].map(([val, lbl]) => (
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "center", gap: 16, flexWrap: "wrap" }}>
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <p style={{ fontSize: 13, color: "rgba(255,255,255,0.65)" }}>
              Setiap klinik yang menggunakan VetCare Pro turut mendanai perawatan hewan liar di seluruh Indonesia. Merawat hewan peliharaan, membantu hewan liar.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: "80px 24px", background: "#f8fffe" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 52 }}>
            <span style={{ fontSize: 12, fontWeight: 700, color: tealMid, letterSpacing: "0.1em", textTransform: "uppercase" }}>Semua yang Anda butuhkan</span>
            <h2 style={{ fontSize: "clamp(26px, 3vw, 40px)", fontWeight: 800, color: "#0d2d2a", marginTop: 8, letterSpacing: "-0.01em" }}>Satu platform. Semua peran.</h2>
            <p style={{ color: "#5a7a76", fontSize: 16, marginTop: 10, maxWidth: 500, margin: "10px auto 0" }}>Dirancang khusus untuk ekosistem veteriner lengkap — dari ponsel pemilik hewan hingga dasbor pemilik klinik.</p>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 20 }}>
            {features.map(({ icon: Icon, title, desc, badge }) => (
              <div key={title} style={{ background: "#fff", borderRadius: 16, padding: 28, border: "1.5px solid hsl(175,30%,92%)", boxShadow: "0 2px 12px rgba(0,80,72,0.06)" }}>
      ...
      <section style={{ padding: "80px 24px", background: "#fff" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            <h2 style={{ fontSize: "clamp(24px, 3vw, 38px)", fontWeight: 800, color: "#0d2d2a" }}>VetCare Pro untuk siapa?</h2>
          </div>
            ...
            {[
              {
                ...
                color: "hsl(175,70%,20%)",
                bg: tealLight,
                items: ["Daftarkan kucing, anjing, dan hewan peliharaan lainnya", "Pantau berat badan, suhu, dan kesehatan dari waktu ke waktu", "Simpan catatan vaksinasi secara digital", "Lihat riwayat kunjungan dan perawatan lengkap"],
              },
              {
                icon: Stethoscope,
                title: "Dokter hewan",
                color: "hsl(210,70%,30%)",
                bg: "hsl(210,80%,94%)",
                items: ["Cari pasien berdasarkan nomor telepon atau nama hewan", "Buat kunjungan rawat inap dan rawat jalan", "Catat laporan harian untuk hewan yang dirawat inap", "Kelola catatan terapi dan penagihan"],
              },
              {
                icon: BarChart3,
                ...
                color: "hsl(145,60%,25%)",
                bg: "hsl(145,60%,93%)",
                items: ["Kelola profil klinik dan staf", "Buat katalog produk dan layanan", "Lihat pendapatan harian, bulanan, dan tahunan", "Pantau volume kunjungan dan kinerja"],
              },
      ...
      <section style={{ padding: "80px 24px", background: "#f0faf8" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 52 }}>
            <h2 style={{ fontSize: "clamp(24px, 3vw, 38px)", fontWeight: 800, color: "#0d2d2a" }}>Langsung bisa digunakan</h2>
            <p style={{ color: "#5a7a76", fontSize: 15, marginTop: 10 }}>Tidak perlu pelatihan. Daftar dan aktifkan profil klinik atau hewan peliharaan Anda sekarang.</p>
          </div>
      ...
      <section style={{ padding: "72px 24px", background: `linear-gradient(135deg, hsl(175,70%,12%) 0%, hsl(175,60%,20%) 100%)` }}>
        <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center" }}>
          ...
          <h2 style={{ fontSize: "clamp(24px, 3vw, 38px)", fontWeight: 800, color: "#fff", marginBottom: 16 }}>Merawat hewan peliharaan. Membantu hewan liar.</h2>
          <p style={{ fontSize: 17, color: "rgba(255,255,255,0.75)", lineHeight: 1.7, marginBottom: 28 }}>
            <strong style={{ color: "#7ae8d8" }}>5% dari setiap rupiah yang kami hasilkan</strong> disumbangkan ke organisasi penyelamatan hewan liar di seluruh Indonesia. Saat Anda menggunakan VetCare Pro, Anda tidak hanya merawat hewan peliharaan — Anda memberikan kesempatan hidup lebih baik bagi hewan-hewan liar.
          </p>
          <div style={{ background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.15)", borderRadius: 12, padding: "16px 24px", display: "inline-block" }}>
            <p style={{ fontSize: 14, color: "rgba(255,255,255,0.7)", margin: 0 }}>
              Setiap langganan klinik · Setiap kunjungan tercatat · Setiap fitur digunakan<br />
              <span style={{ color: "#7ae8d8", fontWeight: 600 }}>5% menjangkau hewan liar yang paling membutuhkan</span>
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: "80px 24px", background: "#fff", textAlign: "center" }}>
        <div style={{ maxWidth: 600, margin: "0 auto" }}>
          <h2 style={{ fontSize: "clamp(26px, 3vw, 42px)", fontWeight: 800, color: "#0d2d2a", marginBottom: 16 }}>Siap untuk memulai?</h2>
          <p style={{ fontSize: 16, color: "#5a7a76", marginBottom: 32, lineHeight: 1.65 }}>Bergabung bersama klinik dan pemilik hewan di seluruh Indonesia yang mempercayai VetCare Pro untuk setiap kunjungan, vaksinasi, dan pemeriksaan.</p>
          <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
      ...
      <footer style={{ background: "hsl(175,50%,10%)", padding: "40px 24px 24px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ borderTop: "1px solid rgba(255,255,255,0.1)", paddingTop: 20, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
            <p style={{ fontSize: 13, color: "rgba(255,255,255,0.4)", margin: 0 }}>© 2026 VetCare Pro. Dibangun untuk klinik yang peduli.</p>
            <p style={{ fontSize: 13, color: "#7ae8d8", margin: 0, display: "flex", alignItems: "center", gap: 6 }}>
              <Heart style={{ width: 13, height: 13 }} /> 5% untuk penyelamatan hewan liar
            </p>
          </div>
        </div>
      </footer>
