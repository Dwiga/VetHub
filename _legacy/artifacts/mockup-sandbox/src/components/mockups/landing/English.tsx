    ...
    >
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            >
              ...
              <a
                href="/__mockup/preview/landing/Indonesian"
                style={{
                  padding: "5px 14px",
                  borderRadius: 6,
                  color: teal,
        ...
        >
          ...
          >
            ...
            <span style={{ fontSize: 13, color: "#7ae8d8", fontWeight: 500 }}>
              Built for Indonesian veterinary clinics
            </span>
          </div>
          <h1
            style={{
          ...
          >
            The smartest way
            <br />
            to care for <span style={{ color: "#7ae8d8" }}>every pet</span>
          </h1>
          <p
            style={{
          ...
          >
            VetHub connects pet owners, veterinarians, and clinic owners — so
            pets get the care they deserve and clinics run smoothly.
          </p>
          <div
            style={{
              display: "flex",
          ...
          >
            {[
              ["100%", "Free to start"],
              ["All-in-one", "Pet + clinic platform"],
              ["Indonesia", "Designed for you"],
            ].map(([val, lbl]) => (
              <div
                key={lbl}
                style={{
        ...
        >
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <p style={{ fontSize: 13, color: "rgba(255,255,255,0.65)" }}>
              Every clinic that uses VetHub helps fund stray animal care across
              Indonesia. Healing pets, helping strays.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: "80px 24px", background: "#f8fffe" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 52 }}>
            ...
            >
              Purpose-built for the full veterinary ecosystem — from the pet
              owner's phone to the clinic owner's dashboard.
            </p>
          </div>
          <div
            style={{
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 52 }}>
            ...
            <p style={{ color: "#5a7a76", fontSize: 15, marginTop: 10 }}>
              No training required. Sign up and get your clinic or pet profile
              active immediately.
            </p>
          </div>
          <div
      ...
      >
        <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center" }}>
          ...
          >
            ...
            is donated to street animal rescue organizations across Indonesia.
            When you use VetHub, you're not just caring for your pet — you're
            giving countless stray animals a chance at a better life.
          </p>
          <div
            style={{
              background: "rgba(255,255,255,0.08)",
          ...
          >
            ...
            >
              Every clinic subscription · Every visit logged · Every feature
              used
              <br />
              <span style={{ color: "#7ae8d8", fontWeight: 600 }}>
                5% reaches the strays who need it most
              </span>
            </p>
          </div>
        </div>
      ...
      >
        <div style={{ maxWidth: 600, margin: "0 auto" }}>
          ...
          >
            Join clinics and pet owners across Indonesia who trust VetHub for
            every visit, every vaccination, every check-up.
          </p>
          <div
            style={{
              display: "flex",
      ...
      >
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          >
            ...
            >
              © 2026 VetHub. Built for clinics that care.
            </p>
            <p
              style={{
                fontSize: 13,
            ...
            >
              <Heart style={{ width: 13, height: 13 }} /> 5% for street animal
              rescue
            </p>
          </div>
        </div>
