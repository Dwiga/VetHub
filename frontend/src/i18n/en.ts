export const en = {
  ...
  guestsDirection: "Type the owner's phone number. If the owner and pet are listed, check in the pet directly. If the owner exists but the pet isn't listed, add a new pet for them. If neither exists yet, just type the number to add both.",
  registeredOwner: "Registered",
  unregisteredContact: "Walk-in",
  noOwnerFoundDirection: "This phone number isn't registered yet. You can create a new guest profile and add their pet.",
  ownerFoundNoPets: "This owner has no pets yet. Add a new pet to continue.",
  info: "Info",
  ...
  soldQty: "Sold",
  totalAmount: "Total",
  paymentAmount: "Payment (Rp)",
  changeAmount: "Change (Rp)",
  ...
  editRoom: "Edit room",
  roomName: "Room name",
  roomNamePlaceholder: "e.g. Cage A, VIP 1",
  roomType: "Room type",
  ...
  noRoomsHint: "Add rooms to manage capacity and prevent double-booking.",
  roomManagementHint: "Click a room to edit. Rooms in maintenance won't appear as available for bookings.",
  deleteRoomConfirm: "Delete this room? Active bookings will be unassigned.",
